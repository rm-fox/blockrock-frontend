...
contract PoolInitializeExampleInputs is Script {
    ...
    address constant HRSK_ADDRESS = address(0x856Fe341c855243fe6947d9053621be728a5ec22); // mUNI deployed to GOERLI -- insert your own contract address here
    address constant MUSDC_ADDRESS = address(0x850f5c0b4EFb99442E877ec1D9D7210666ade441); // mUSDC deployed to GOERLI -- insert your own contract address here
